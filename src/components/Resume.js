    ...
    return (
        <div className="box-timeline">
            ...
            <div className="box b3" data-anim="3">
                <h3>Html, and Css</h3>
                <p>I started to learn coding and appreciate to discover new skills, it was the beginning for an amazing coding experience. It is tough for a swimming teacher but with motivation a kept going.</p>
                <a href="#" alt="timeline" className="btn">www.Codecademy.com</a>
            </div>
